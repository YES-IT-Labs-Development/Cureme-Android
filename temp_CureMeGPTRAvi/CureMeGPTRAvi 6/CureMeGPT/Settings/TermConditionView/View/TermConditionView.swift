...
struct TermConditionView: View {
    @StateObject private var vm = TermConditionViewModel()
        ...
        ZStack{
            VStack{
                HStack{
                    ...
                    Text(vm.TermConditionData?.data?.title ?? "")
                ...
                VStack(alignment: .leading) {
                    ScrollView {
                        Text(highlightedText(vm.TermConditionData?.data?.content ?? ""))
            ...
            .onAppear {
                vm.apiTermConditionData()   // ✅ IMPORTANT
            }
